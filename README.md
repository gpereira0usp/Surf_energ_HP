...
The project scripts and notebooks were updated to work with the root-level organization above. The legacy `data/CsPbBr3/...` location is still accepted as a fallback by the analysis script.
